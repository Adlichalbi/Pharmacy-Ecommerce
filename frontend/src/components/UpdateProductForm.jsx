...
const categories = ["baby-care", "Personal-Care", "Fitness-and-Wellness", 
  "Health-Supplements", "Medicines", "First-Aid"];
...
const UpdateProductForm = () => {
  ...
  // Log productId for debugging purposes
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!id) {
      ...
      return; // Prevent form submission if productId is missing
    }

    try {
      await UpdateProduct(id, newProduct);
      setNewProduct({ name: "", description: "", price: "", category: "", image: "" });
      navigate("/secret-dashboard"); // Optional redirect after update
    } catch {
